    ...
    <>
      ...
      <div className={`${syne.variable} ${inter.variable} ${instrumentSerif.variable}`}>
        ...
        <section id="hero" className="hero-fullbleed">
          ...
          {/* Fox mascot — mirrors KCD's 3D animal character */}
          <svg
          ...
          >
            ...
            <ellipse cx="30" cy="60" rx="9" ry="14" fill="#5ec7a0" opacity="0.75" transform="rotate(-30 30 60)"/>
            <ellipse cx="220" cy="45" rx="7" ry="11" fill="#68d9c0" opacity="0.65" transform="rotate(20 220 45)"/>
            <ellipse cx="240" cy="130" rx="6" ry="10" fill="#5ec7a0" opacity="0.6" transform="rotate(-15 240 130)"/>
            <ellipse cx="18" cy="175" rx="8" ry="12" fill="#68d9c0" opacity="0.55" transform="rotate(25 18 175)"/>
            <circle cx="48" cy="40" r="3" fill="#ffd644" opacity="0.7"/>
            <circle cx="215" cy="80" r="2.5" fill="#ffd644" opacity="0.6"/>
            <circle cx="235" cy="200" r="2" fill="#ffffff" opacity="0.4"/>

            {/* ── Hoverboard / skateboard ── */}
            <rect x="55" y="280" width="150" height="18" rx="9" fill="#ff7b3d"/>
            <rect x="55" y="280" width="150" height="8" rx="4" fill="#ff9560" opacity="0.6"/>
            {/* wheels */}
            <ellipse cx="88" cy="298" rx="11" ry="8" fill="#2e3039"/>
            <ellipse cx="88" cy="298" rx="7" ry="5" fill="#444"/>
            <ellipse cx="172" cy="298" rx="11" ry="8" fill="#2e3039"/>
            <ellipse cx="172" cy="298" rx="7" ry="5" fill="#444"/>

            {/* ── Body ── */}
            {/* legs */}
            <rect x="98" y="248" width="22" height="34" rx="10" fill="#1e1e2e"/>
            <rect x="140" y="248" width="22" height="34" rx="10" fill="#1e1e2e"/>
            {/* sneakers */}
            <ellipse cx="109" cy="282" rx="16" ry="9" fill="#ffffff"/>
            <ellipse cx="151" cy="282" rx="16" ry="9" fill="#ffffff"/>
            <rect x="94" y="274" width="30" height="10" rx="5" fill="#e8e8e8"/>
            <rect x="136" y="274" width="30" height="10" rx="5" fill="#e8e8e8"/>
            {/* shoe accents */}
            <rect x="101" y="276" width="16" height="3" rx="1.5" fill="#ffd644" opacity="0.8"/>
            <rect x="143" y="276" width="16" height="3" rx="1.5" fill="#ffd644" opacity="0.8"/>

            {/* torso — hoodie */}
            <rect x="80" y="180" width="100" height="80" rx="28" fill="#e05a1e"/>
            {/* hoodie pocket */}
            <rect x="108" y="230" width="44" height="24" rx="8" fill="#c94e18"/>
            {/* hoodie inner shirt pattern */}
            <ellipse cx="130" cy="195" rx="24" ry="28" fill="#f5d5b8" opacity="0.9"/>
            {/* hoodie zipper line */}
            <line x1="130" y1="183" x2="130" y2="254" stroke="#c94e18" strokeWidth="2" opacity="0.6"/>

            {/* arms */}
            {/* left arm (raised slightly) */}
            <path d="M80 200 Q48 190 38 215 Q34 228 50 230 Q64 232 80 218Z" fill="#e05a1e"/>
            {/* left paw */}
            <ellipse cx="42" cy="228" rx="16" ry="12" fill="#2e2e3e"/>
            <ellipse cx="36" cy="222" rx="6" ry="5" fill="#3a3a4e"/>
            <ellipse cx="42" cy="219" rx="6" ry="5" fill="#3a3a4e"/>
            <ellipse cx="48" cy="222" rx="6" ry="5" fill="#3a3a4e"/>

            {/* right arm */}
            <path d="M180 200 Q212 190 222 215 Q226 228 210 230 Q196 232 180 218Z" fill="#e05a1e"/>
            {/* right paw */}
            <ellipse cx="218" cy="228" rx="16" ry="12" fill="#2e2e3e"/>
            <ellipse cx="212" cy="219" rx="6" ry="5" fill="#3a3a4e"/>
            <ellipse cx="218" cy="219" rx="6" ry="5" fill="#3a3a4e"/>
            <ellipse cx="224" cy="222" rx="6" ry="5" fill="#3a3a4e"/>

            {/* ── Head ── */}
            {/* main head */}
            <ellipse cx="130" cy="140" rx="60" ry="58" fill="#d95c1a"/>
            {/* forehead lighter patch */}
            <ellipse cx="130" cy="125" rx="38" ry="30" fill="#e87535" opacity="0.6"/>

            {/* ears */}
            {/* left ear outer */}
            <polygon points="75,95 58,52 100,80" fill="#d95c1a"/>
            {/* left ear inner */}
            <polygon points="78,92 65,60 96,78" fill="#ff8c42" opacity="0.7"/>
            {/* right ear outer */}
            <polygon points="185,95 202,52 160,80" fill="#d95c1a"/>
            {/* right ear inner */}
            <polygon points="182,92 195,60 164,78" fill="#ff8c42" opacity="0.7"/>

            {/* face — white muzzle */}
            <ellipse cx="130" cy="158" rx="32" ry="26" fill="#f5d5b8"/>
            {/* nose */}
            <ellipse cx="130" cy="152" rx="10" ry="7" fill="#1e1e2e"/>
            <ellipse cx="127" cy="150" rx="3" ry="2" fill="#3a3a3a" opacity="0.5"/>
            {/* nose highlight */}
            <circle cx="133" cy="150" r="2.5" fill="#555" opacity="0.6"/>

            {/* eyes */}
            {/* left eye white */}
            <ellipse cx="108" cy="132" rx="13" ry="13" fill="#ffffff"/>
            {/* left iris */}
            <ellipse cx="109" cy="133" rx="8" ry="9" fill="#3d2200"/>
            {/* left pupil */}
            <ellipse cx="110" cy="134" rx="5" ry="6" fill="#0a0a0a"/>
            {/* left highlight */}
            <circle cx="113" cy="130" r="3" fill="#ffffff" opacity="0.9"/>
            <circle cx="107" cy="136" r="1.5" fill="#ffffff" opacity="0.5"/>

            {/* right eye white */}
            <ellipse cx="152" cy="132" rx="13" ry="13" fill="#ffffff"/>
            {/* right iris */}
            <ellipse cx="151" cy="133" rx="8" ry="9" fill="#3d2200"/>
            {/* right pupil */}
            <ellipse cx="150" cy="134" rx="5" ry="6" fill="#0a0a0a"/>
            {/* right highlight */}
            <circle cx="155" cy="130" r="3" fill="#ffffff" opacity="0.9"/>
            <circle cx="149" cy="136" r="1.5" fill="#ffffff" opacity="0.5"/>

            {/* eyebrows */}
            <path d="M98 120 Q108 114 118 118" stroke="#7a3a00" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
            <path d="M142 118 Q152 114 162 120" stroke="#7a3a00" strokeWidth="2.5" fill="none" strokeLinecap="round"/>

            {/* mouth — slight smile */}
            <path d="M118 163 Q130 173 142 163" stroke="#a0522d" strokeWidth="2" fill="none" strokeLinecap="round"/>

            {/* cheek blush */}
            <ellipse cx="96" cy="150" rx="10" ry="7" fill="#ff9966" opacity="0.35"/>
            <ellipse cx="164" cy="150" rx="10" ry="7" fill="#ff9966" opacity="0.35"/>

            {/* ── Tail peeking ── */}
            <path d="M178 240 Q220 210 235 235 Q250 255 220 265 Q200 270 185 258Z" fill="#d95c1a"/>
            <path d="M218 260 Q238 252 232 238 Q226 226 212 238Z" fill="#f5d5b8" opacity="0.9"/>

            {/* ── Laptop/device in paws (coding fox!) ── */}
            <rect x="88" y="228" width="84" height="52" rx="6" fill="#1e1e2e"/>
            <rect x="92" y="232" width="76" height="40" rx="4" fill="#0f1117"/>
            {/* code lines on screen */}
            <rect x="97" y="238" width="30" height="3" rx="1.5" fill="#ffd644" opacity="0.8"/>
            <rect x="97" y="244" width="44" height="3" rx="1.5" fill="#68d94a" opacity="0.7"/>
            <rect x="97" y="250" width="36" height="3" rx="1.5" fill="#4b96ff" opacity="0.7"/>
            <rect x="97" y="256" width="20" height="3" rx="1.5" fill="#ffd644" opacity="0.5"/>
            <rect x="120" y="256" width="16" height="3" rx="1.5" fill="#ff6b6b" opacity="0.6"/>
            {/* cursor blink */}
            <rect x="97" y="262" width="3" height="5" rx="1" fill="#ffffff" opacity="0.9"/>
          </svg>
        </section>
